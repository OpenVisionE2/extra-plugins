...
class RCSetupScreen(Screen, ConfigListScreen):
	...
	<screen position="c-200,c-100" size="400,200" title="Remote setup">
		...
		<widget name="ok" position="c-145,e-45" size="140,40" verticalAlignment="center" horizontalAlignment="center" zPosition="1" font="Regular;20" transparent="1" backgroundColor="green" />
		<widget name="cancel" position="c+5,e-45" size="140,40" verticalAlignment="center" horizontalAlignment="center" zPosition="1" font="Regular;20" transparent="1" backgroundColor="red" />
	</screen>"""
