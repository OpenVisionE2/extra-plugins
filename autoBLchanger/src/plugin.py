...
def autoChangeBootLogo():
	try:
		BLogos = sorted(searchForFiles(strSearchPath, 1))
...
class autoBLchanger(Screen, ConfigListScreen):
	skin = """
	<screen name="autoBLchanger" position="center,center" size="650,715" title="{title_ver}" flags="wfNoBorder" backgroundColor="#00000000">
		...
		<eLabel name="myTitle" position="25,12" size="220,30" text="{title}" horizontalAlignment="right" verticalAlignment="center" font="Console; 25" foregroundColor="#00c8c8c8" transparent="1" zPosition="1" />
		<eLabel name="myVersion" position="255,12" size="100,30" text="({version})" horizontalAlignment="left" verticalAlignment="bottom" font="Console; 18" foregroundColor="#00c8c8c8" transparent="1" zPosition="1" />
		...
		<widget name="LogosInfo" position="25,550" size="600,80" horizontalAlignment="left" verticalAlignment="top" font="Console; 22" foregroundColor="#00c8c8c8" transparent="1" zPosition="1" />
		<widget name="LogosPict" position="325,371" size="300,169" alphaTest="on" zPosition="2" borderWidth="1" borderColor="#005a5a5a" />
		<widget name="key_red" position="25,640" size="150,45" horizontalAlignment="center" verticalAlignment="center" font="Regular; 20" foregroundColor="#00c8c8c8" transparent="1" zPosition="1" />
		<widget name="key_green" position="175,640" size="150,45" horizontalAlignment="center" verticalAlignment="center" font="Regular; 20" foregroundColor="#00c8c8c8" transparent="1" zPosition="1" />
		<widget name="key_yellow" position="325,640" size="150,45" horizontalAlignment="center" verticalAlignment="center" font="Regular; 20" foregroundColor="#00c8c8c8" transparent="1" zPosition="1" />
		<widget name="key_blue" position="475,640" size="150,45" horizontalAlignment="center" verticalAlignment="center" font="Regular; 20" foregroundColor="#00c8c8c8" transparent="1" zPosition="1" />
