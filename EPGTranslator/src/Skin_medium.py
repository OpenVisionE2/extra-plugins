...
#
    translatorConfig_skin = """
        <screen position="center,center" size="1218,788" backgroundColor="#20000000" title="EPG Translator Setup">
            ...
            <widget name="config" position="15,90" size="1188,290" itemHeight="57" scrollbarMode="showOnDemand" font="Regular;36" valueFont="Regular;36" zPosition="1" />
            ...
            <eLabel position="355,414" size="270,40" font="Regular;36" horizontalAlignment="left" text="Save" transparent="1" zPosition="1" />
            <eLabel position="833,414" size="270,40" font="Regular;36" horizontalAlignment="left" text="Cancel" transparent="1" zPosition="1" />
...
#
    translatorMain_skin = """
        <screen position="center,120" size="1500,915" title="EPG Translator">
            ...
            <widget name="label" position="51,9" size="300,30" font="Regular;24" foregroundColor="black" backgroundColor="#FFFFFF" horizontalAlignment="left" transparent="1" zPosition="2" />
            <widget name="label2" position="51,39" size="300,30" font="Regular;24" foregroundColor="black" backgroundColor="#FFFFFF" horizontalAlignment="left" transparent="1" zPosition="2" />
            <widget render="Label" source="global.CurrentTime" position="1110,0" size="360,75" font="Regular;36" foregroundColor="#697178" backgroundColor="#FFFFFF" horizontalAlignment="right" verticalAlignment="center" zPosition="2">
                <convert type="ClockToText">Format:%H:%M:%S</convert>
            </widget>
            <widget name="timing" position="318,90" size="1200,50" foregroundColor="orange" font="Bold;36" horizontalAlignment="left" zPosition="1" />
            <widget name="flag" position="15,140" size="288,288" alphaTest="blend" zPosition="1" />
            <widget name="text" position="318,140" size="1200,{size}" font="Regular;36" horizontalAlignment="left" zPosition="2" />
            <widget name="flag2" position="15,530" size="288,288" alphaTest="blend" zPosition="1" />
            <widget name="text2" position="318,530" size="1200,385" font="Regular;36" horizontalAlignment="left" zPosition="1" />
        </screen>
        """
    tMyes = "380"
    tMno = "770"
