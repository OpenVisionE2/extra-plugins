...
class ABMCustomMixImporterScreen(Setup):
	skin = """
		<screen position="340,70" size="600,620">
			...
			<widget source="key_blue" render="Label" position="450,0" size="140,40" verticalAlignment="center" horizontalAlignment="center" zPosition="4" foregroundColor="white" backgroundColor="#a08500" font="Regular;18" transparent="1"/>
