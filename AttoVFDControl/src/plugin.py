...
def Plugins(**kwargs):
    return [PluginDescriptor(where=[PluginDescriptor.WHERE_AUTOSTART, PluginDescriptor.WHERE_SESSIONSTART], fnc=sessionstart), PluginDescriptor(name='Atto LED Display Setup', description=_('Change VFD display settings'), where=PluginDescriptor.WHERE_MENU, fnc=main)]
